...
//	}
	...
	@GetMapping("{noticeno}")
	public ResponseEntity<NoticeDto> getNoticepage(@PathVariable("noticeno") @ApiParam(value = "얻어올 글의 글번호.", required = true) int notice_no) throws Exception {
	...
	public ResponseEntity<String> deleteNoticepage(@PathVariable("noticeno") @ApiParam(value = "살제할 글의 글번호.", required = true) int notice_no) throws Exception {
